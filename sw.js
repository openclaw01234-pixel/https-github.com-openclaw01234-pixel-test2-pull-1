...
const CACHE = 'mxpro-v6-pro-' + new Date().toISOString().slice(0, 10);
const ASSETS = [
  './',
  './index.html',
  './manifest.json',
  ...
  './scripts/library.js',
  './scripts/vault.js',
  './scripts/video-opener.js',
  './scripts/subtitles.js',
  './scripts/media-session.js',
  './scripts/external-helpers.js',
